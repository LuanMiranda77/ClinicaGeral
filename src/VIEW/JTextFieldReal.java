...
public class JTextFieldReal extends JTextField {
	 ...
	 */
	    ...
	    public JTextFieldReal(int casasDecimais) {
	        this(new DecimalFormat((casasDecimais == 0 ? "#,##0" : "#,##0.") + makeZeros(casasDecimais)));
	    }
	 
	    public JTextFieldReal() {
	        this(MONETARY_FORMAT);
	    }
	 
	    public JTextFieldReal(NumberFormat format) {// define o formato do
	        // número
	        ...
	        setDocument(new PlainDocument() {
	            ...
	            public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
	                String text = new StringBuilder(JTextFieldReal.this.getText().replaceAll("[^0-9]", "")).append(str.replaceAll("[^0-9]", "")).toString();
	    ...
	    public static void main(String[] args) {
	        ...
	        frame.add(new JTextFieldReal(new DecimalFormat("0.00")) {
	            /**
				 * 
				 */
				private static final long serialVersionUID = 1L;
